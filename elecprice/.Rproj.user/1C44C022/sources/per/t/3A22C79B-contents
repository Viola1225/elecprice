shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      p(class="text-small",
        a(href="http://1-------------", target="_blank","by XLZ"),
        a(href="https://github.com/Viola1225", target="_blank",icon("github"))," | ",
        a(href="http://3-------------", target="_blank",icon("linkedin"))),
      hr(),
      p(class="text-small","Data Visulisation on Market Rankings and Price of ELEC Products. 
        All Data is derived from the PUC website: ",
    ...
    mainPanel(
      tabsetPanel(
        tabPanel("Rankings",
                  h2("Rankings"),
                  p(class="text-small", "This visualizes the rankings of Retail Electric Providers in ERCOT,
